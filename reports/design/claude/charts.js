/* ==========================================================================
   ...
   (claude kit copy — identical engine; colors come from this kit's themed
   tokens. Expose chart init as window.renderCharts so kit.js re-renders on
   theme change and around printing.)
