---
name: vault-prep
description: Assemble a meeting preparation pack from the vault — attendee one-liners, open threads in both directions, state of play, likely landmines, and suggested talking points. Use when the principal has a meeting coming up and asks to be prepped, briefed on who will be in the room, or wants an agenda or pre-read for an upcoming discussion.
---

# Meeting preparation pack

The principal has a meeting coming up. Make sure they walk in knowing more
than anyone else in the room. Work from the topic and attendees they give
you, plus anything they paste such as an invite or agenda. Ask for the topic
or attendees if neither is supplied.
...
2. Assemble the pack in chat, tight and scannable:
   ...
   - **Open threads** — commitments in both directions with these people, and
